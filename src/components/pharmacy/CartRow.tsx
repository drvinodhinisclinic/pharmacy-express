    ...
    <tr className="group">
      ...
      <td>
        <input
          ...
          min="1"
          value={item.quantity}
          onChange={(e) => onQuantityChange(item.ProductID, Math.max(1, parseInt(e.target.value) || 1))}
      ...
      <td>
        <input
          type="text"
          value={item.batch}
          onChange={(e) => onBatchChange(item.ProductID, e.target.value)}
          placeholder="Batch"
          className="w-20 px-2 py-1 text-xs border border-input rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-ring"
        />
      </td>
      <td>
        <input
          ...
          onChange={(e) => onExpiryChange(item.ProductID, e.target.value)}
      ...
      <td>
        <input
          ...
          onChange={(e) => onSalePriceChange(item.ProductID, parseFloat(e.target.value) || 0)}
